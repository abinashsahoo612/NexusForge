...
namespace TaskManagementSystem.Migrations
{
    ...
    [Migration("20260906081543_AddPermissionSeedData")]
    partial class AddPermissionSeedData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagementSystem.Models.Activity.ActivityLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TaskManagementSystem.Models.Permissions.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TaskManagementSystem.Models.Permissions.WorkspaceRolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TaskManagementSystem.Models.Workspaces.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TaskManagementSystem.Models.Activity.ActivityLog", b =>
                {
                    b.HasOne("TaskManagementSystem.Models.Workspaces.Project", "Project")
                        .WithMany()
                        .HasForeignKey("ProjectId");

                    b.HasOne("TaskManagementSystem.Models.Task.TaskItem", "Task")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManagementSystem.Models.Permissions.WorkspaceRolePermission", b =>
                {
                    b.HasOne("TaskManagementSystem.Models.Permissions.Permission", "Permission")
            ...
            modelBuilder.Entity("TaskManagementSystem.Models.Task.TaskItem", b =>
                {
                    b.HasOne("TaskManagementSystem.Models.Identity.ApplicationUser", "AssignedToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManagementSystem.Models.Workspaces.WorkspaceMember", b =>
                {
                    b.HasOne("TaskManagementSystem.Models.Identity.ApplicationUser", "AddedByUser")
                        .WithMany()
